...
class iminerLocals extends XoopsObject
{
    ...
    {   	
        ...
        self::initVar('type', XOBJ_DTYPE_ENUM, 'png', false, false, false, array('gif','jpg','png'));
 ...
 */
class iminerLocalsHandler extends XoopsPersistableObjectHandler
{
