...
class iminerFielding extends XoopsObject
{
    ...
    {   	
        ...
        self::initVar('primary', XOBJ_DTYPE_TXTBOX, null, false, 128);
        self::initVar('unixtime', XOBJ_DTYPE_TXTBOX, null, false, 128);
        self::initVar('userid', XOBJ_DTYPE_TXTBOX, null, false, 128);
 ...
 */
class iminerFieldingHandler extends XoopsPersistableObjectHandler
{
